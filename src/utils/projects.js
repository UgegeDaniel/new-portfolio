const projects = [
    ...
    {
      name: 'Chakra Movies',
      desc: 'This is a React / Typescript app to help people search through movies by categories, search for specific movies and preview movie details. Its a simple app to demostrate the basic features of the react library.',
    ...
    {
      name: 'Game of Quotes',
      desc: 'This is a React app that displays notable quotes by our favorite characters from the HBO series \'Game of Thrones\'. Its a simple app that demostrates the basic features of the React library.',
